    ...
    <section className={`${styles.home} section`} id="home" style={{height:"100vh"}}>
      <div style={{ position: "relative"}}>
        <div style={{ position: "relative", top:"0"}}>
          <video
            className={`${styles.videoBg} lazy w-100`}
            autoPlay
            loop
            muted
            playsInline
            ...
            <FadeAnimation top>
              <div className={styles.home__data}>
                ...
                <p className={styles.home__description}>
                  We enhance your social media presence, perfect your website
                  and search engine rank, prepare a digital strategy and
                  leverage automated client acquisition systems for you to see a
                  minimum 5x in your return on investment under 30 days, or your
                  money back.
                </p>
                <div>
