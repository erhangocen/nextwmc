...
export default function AboutDetails() {
  return (
    <section
      className={`${styles.about__details} section`}
      id="about"
      data-aos="fade-top"
    >
      <Fade triggerOnce>
        <h2 className={`${styles.about__details__title} section__title`}>
          - Who We Are -
        </h2>
        <div
          className={`${styles.about__container} ${styles.about__details__container} container grid`}
        >
          ...
          <div className={styles.about__data}>
            ...
            <p
              className={`${styles.about__description} ${styles.about__leadership__description}`}
            >
              Western Money Consulting is a social media marketing agency
              located in West London. Our goal is to blend traditional marketing
              methods with cutting-edge technology to create both financial and
              leisure benefits for our clients.
            </p>
            <div className={styles.leadership__scroll} data-aos="fade-top">
              <a
                href="#leadership"
                className={`${styles.leadership__scroll_button} button__flex text-white`}
              >
      ...
      <div className={styles.leadership__section} id="leadership">
        <h2 className={`section__title ${styles.leadership__title}`}>
          - Leadership -
        </h2>
